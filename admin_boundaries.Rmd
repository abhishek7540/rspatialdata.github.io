...
#install.packages(c("rgeoboundaries", "ggplot2"))
library(rgeoboundaries)
library(ggplot2)
...
nigeria_chad_admlvl2_boundaries %>% leaflet() %>% 
  addTiles() %>% 
  addPolygons(label = nigeria_chad_admlvl2_boundaries$shapeName)

```
<!---

# When do we want to use `rnaturalearth` and when rgeoboundaries?
