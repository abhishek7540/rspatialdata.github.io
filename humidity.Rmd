...
We have already seen a tutorial on how to retrieve the rainfall attribute using the `nasapower` package. Please have a look at the rainfall tutorial [here](https://rspatialdata.github.io/rainfall) for the general knowledge on how the `nasapower` package and it's functions work. 
