...
Since IGBP land cover classification data is provided annually and dated on the ^1^st of January each year, the `start-date` and `end_date` arguments should contain the ^1^st of January of each year for which we want the data to be downloaded.
...
```{r zimbabwe-example-download, eval = FALSE}
...
Visualising land cover in Zimbabwe using `ggplot2`

```{r zimbabwe-example-ggplot2}
